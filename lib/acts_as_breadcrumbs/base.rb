    ...
    module Breadcrumbs
      module Base
        ...
        module ClassMethods
          ...
          # on acts_as_nested_set methods, parent and children
          #
          # Options are:
          ...
          def acts_as_breadcrumbs(options = {})
            ...
            # Creates a breadcrumb string based on an acts_as_nested_set model
            create = "
            ...
            save_callbacks = "
              before_validation :on => :create do |record|
                @new_record_for_#{breadcrumbs_attr} = true
              end
              ...
              after_commit :on => :create do |record|
                if @new_record_for_#{breadcrumbs_attr}
                  @new_record_for_#{breadcrumbs_attr} = false
                  
                  record.create_breadcrumb_#{breadcrumbs_attr}
                  record.save
                end
              end
            "
